          ...
          {mode === 'privacy' ? (
            ...
            <article className="prose prose-slate dark:prose-invert max-w-none">
              ...
              <div className="space-y-6 text-sm text-slate-600 dark:text-slate-400 leading-relaxed font-sans">
                ...
                <p>
                  TextToolkitHub offers a comprehensive suite of 56+ utilities—including <strong>Word Counter</strong>, <strong>Readability Checker</strong>, <strong>JSON Formatter</strong>, <strong>YAML/JSON Converter</strong>, <strong>Hash Generator</strong>, <strong>UUID Generator</strong>, <strong>Color Contrast Checker</strong>, <strong>Unix Timestamp Converter</strong>, <strong>Markdown Table Generator & Editor</strong>, <strong>Text-to-Speech Reader</strong>, <strong>HTML & XML Formatter</strong>, <strong>Text ↔ Binary Translator</strong>, and <strong>JSON ↔ XML Converter</strong>. 
                </p>
                <p>
