...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: 'Convert Excel spreadsheets (.xlsx, .xls, .csv) into clean, formatted PDF documents. 100% private browser processing.',
    longDescription: 'Transform your Excel workbooks, financial tables, and CSV spreadsheets into professional PDF documents directly in your browser memory. Choose sheet selections, table grid styles, font sizes, and landscape orientation with zero server uploads.',
    iconName: 'FileSpreadsheet',
    category: 'converter',
    seoTitle: 'Free Excel to PDF Converter Online | Convert XLSX, XLS, CSV to PDF Locally',
    seoDescription: 'Convert Excel files to PDF online for free with 100% client-side privacy. Support multi-sheet workbooks, landscape layout, auto-fit tables, and instant PDF download with zero server uploads.',
    keywords: ['excel to pdf', 'xlsx to pdf', 'xls to pdf', 'csv to pdf', 'convert excel to pdf', 'spreadsheet to pdf', 'local excel to pdf', 'client side excel to pdf'],
  },
  {
    id: 'tools/pdf-to-excel',
    title: 'PDF to Excel Converter',
    description: 'Extract PDF tables into Excel (.xlsx) and CSV spreadsheets. 100% private browser processing.',
    longDescription: 'Convert PDF tables, bank statements, invoices, and reports into clean, editable Excel workbooks directly inside your browser memory. Inspect real-time table previews and export as .xlsx or .csv with zero server uploads.',
    iconName: 'FileSpreadsheet',
    category: 'converter',
    seoTitle: 'Free PDF to Excel Converter Online | Convert PDF to XLSX, CSV Locally',
    seoDescription: 'Convert PDF tables to Excel online for free with 100% client-side privacy. Extract tables, inspect real-time grid previews, and export as XLSX or CSV with zero server uploads.',
    keywords: ['pdf to excel', 'pdf to xlsx', 'pdf to csv', 'extract pdf table', 'convert pdf to excel', 'pdf table extractor', 'client side pdf to excel'],
  },
  {
  ...
  },
  {
    ...
    description: 'Create, format and edit beautifully aligned Markdown, HTML, and CSV tables visually with an interactive grid.',
    longDescription: 'Design tables visually with column alignment, simple cell edits, and row/column additions. Instantly copy output as Github-Flavored Markdown tables, clean HTML tables, or standard CSV values.',
    iconName: 'Table',
    category: 'generator',
    seoTitle: 'Markdown Table Generator Online | Free Table Creator',
    seoDescription: 'Create beautifully aligned Markdown, HTML, and CSV tables instantly with our visual, interactive grid creator tool. Free & client-side offline.',
    keywords: ['markdown table generator', 'create markdown table', 'gfm table generator', 'visual table creator', 'html table converter', 'csv to markdown table'],
  },
  {
    id: 'tools/text-to-speech',
    title: 'Text to Speech Reader',
    description: 'Convert custom written documents, novels, or articles into natural vocal synthesis securely in your browser.',
    longDescription: 'Listen to any text with standard local system voices, with speed and pitch controls. 100% private and offline, perfect for reviewing drafts, pronunciation, and accessibility reading.',
    iconName: 'Volume2',
    category: 'generator',
    seoTitle: 'Text to Speech Reader Online | Client-side TTS Converter',
    seoDescription: 'Convert text into natural sounding voice accents instantly with our browser-native Text to Speech utility. 100% offline and secure.',
    keywords: ['text to speech reader', 'tts converter online', 'free tts reader', 'read text aloud', 'offline tts reader', 'browser speech synthesis'],
  },
  {
    id: 'tools/html-formatter',
    title: 'HTML & XML Formatter',
    description: 'Clean, pretty-print, format, and indent messy HTML and XML markup or minify code to compress size.',
    longDescription: 'Format, beautify, and validate HTML and XML hierarchies instantly. Configure custom indentation offsets or minify tag-heavy scripts to boost page load speed 100% locally.',
    iconName: 'Code2',
    category: 'cleaner',
    seoTitle: 'HTML & XML Formatter Online | Beautifier & Minifier',
    seoDescription: 'Format, beautify, and minify HTML or XML markup code instantly with our free online utility. Live syntax checks and tag inspection, 100% offline.',
    keywords: ['html formatter', 'xml beautifier', 'pretty print html', 'xml formatter online', 'minify html markup', 'compress xml data'],
  },
  {
    id: 'tools/text-to-binary',
    title: 'Text to Binary Translator',
    description: 'Convert standard text characters into binary machine code bits, Hexadecimal arrays, or ASCII decimals instantly.',
    longDescription: 'Fast bidirectional translation: convert text strings into binary bytes (0s and 1s), hexadecimal base-16 strings, or ASCII integer decimal codes, and translate them back to readable text.',
    iconName: 'Binary',
    category: 'converter',
    seoTitle: 'Text to Binary Converter Online | Hex & ASCII Translator',
    seoDescription: 'Convert text to binary, hexadecimal, and ASCII codes, or decode binary bytes back to readable text instantly with our bidirectional offline converter.',
    keywords: ['text to binary converter', 'binary to text translator', 'text to hex converter', 'hex to text translator', 'ascii to binary converter', 'binary decoder'],
  },
  {
    id: 'tools/json-xml-converter',
    title: 'JSON to XML Converter',
    description: 'Convert structured JSON strings into clean nested XML tags, and parse XML trees back to standard JSON.',
    longDescription: 'Seamlessly convert data structures: transform lightweight JSON models into Extensible Markup Language (XML) trees, or parse XML data back to readable JSON, supporting repeated elements and attributes.',
    iconName: 'RefreshCw',
    category: 'converter',
